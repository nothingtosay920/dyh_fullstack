<template>
  <header class="home-header wrap" :class="{'active': headerScroll}">
    <router-link tag="i" class="iconfont icon-caidan" to="/category"></router-link>
  ...
  <goodsList :title="'最新推荐'" :goods="recommendGoodses" :style="{paddingBottom: '100px'}"></goodsList>
</template>
